...
import { MEAD, POWELL } from "@/lib/reservoirs";
...
export const metadata = { title: "The System — Basin" };

export default async function TheSystem() {
  ...
  return (
    <main>
      ...
      <p className="page-lede">
        ...
        This chapter is the whole system in five scenes — scroll through the
        guided story, then meet the three numbers that explain everything else.
      </p>
      ...
      <p className="chain-caveat">
        ...
        is live from Reclamation RISE, provisional. Prefer to roam freely?
        The same map is an instrument:{" "}
        <Link href={"/explore/map" as Route}>open the basin map</Link>.
      </p>
        ...
        <div className="note">
          ...
          <p>
            ...
            <Link href={"/report/demand" as Route}>
              every city in the basin combined
            </Link>{" "}
            is under a fifth of consumption.
          </p>
        </div>
      </div>
      ...
      <div className="chain-caveat" style={{ marginTop: 26 }}>
        ...
        and peer-reviewed studies, each dated and cited in the{" "}
        <Link href={"/report/supply" as Route}>Supply</Link> and{" "}
        <Link href={"/report/demand" as Route}>Demand</Link> chapters.
      </div>

      <ChapterPager slug="the-system" />
    </main>
  );
}
